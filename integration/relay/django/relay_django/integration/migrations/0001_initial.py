    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Set this name to the TeamServer Generic Webhook Payload.', max_length=20, unique=True, validators=[django.core.validators.RegexValidator(message='名前は半角英数字、アンスコ4文字〜10文字です。', regex='^[A-Za-z0-9_]{4,20}$')], verbose_name='Name')),
                ('url', models.URLField(help_text='e.g. https://app.contrastsecurity.com/Contrast', verbose_name='TeamServer URL')),
                ('org_id', models.CharField(max_length=36, verbose_name='Organization ID')),
                ('api_key', models.CharField(max_length=50, verbose_name='API Key')),
                ('username', models.CharField(help_text='Login ID (mail address)', max_length=20, verbose_name='Username')),
                ('service_key', models.CharField(max_length=20, verbose_name='Service Key')),
