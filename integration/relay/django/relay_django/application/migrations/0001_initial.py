# Generated by Django 2.2.13 on 2020-12-25 02:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority_critical', models.CharField(blank=True, max_length=50, null=True, verbose_name='Critical')),
                ('priority_critical_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='Critical ID')),
                ('priority_high', models.CharField(blank=True, max_length=50, null=True, verbose_name='High')),
                ('priority_high_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='High ID')),
                ('priority_medium', models.CharField(blank=True, max_length=50, null=True, verbose_name='Medium')),
                ('priority_medium_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='Medium ID')),
                ('priority_low', models.CharField(blank=True, max_length=50, null=True, verbose_name='Low')),
                ('priority_low_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='Low ID')),
                ('priority_note', models.CharField(blank=True, max_length=50, null=True, verbose_name='Note')),
                ('priority_note_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='Note ID')),
                ('priority_cvelib', models.CharField(blank=True, max_length=50, null=True, verbose_name='CVE Lib')),
                ('priority_cvelib_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='CVE Lib ID')),
