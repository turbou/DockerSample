    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_id', models.PositiveSmallIntegerField(verbose_name='Issue IID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note_id', models.PositiveSmallIntegerField(verbose_name='Gitlab Comment ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contrast_app_id', models.CharField(max_length=36, verbose_name='Application ID')),
                ('contrast_vul_id', models.CharField(blank=True, max_length=19, null=True, verbose_name='Vulnerability ID')),
                ('issue_id', models.PositiveSmallIntegerField(verbose_name='Issue ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True, null=True, verbose_name='Updated')),
                ('contrast_note_id', models.CharField(max_length=36, unique=True, verbose_name='Contrast Note ID')),
                ('note_id', models.PositiveSmallIntegerField(verbose_name='Backlog Comment ID')),
