...
# Create Subnet(Secondary)
aws ec2 create-subnet --vpc-id [VPC_ID] --cidr-block 10.0.1.0/24 --tag-specifications ResourceType=subnet,Tags=[{"Key=Name,Value=ECS tomcat - Secondary Subnet"}]
